...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://git.wickrlan.net/cross-clib/wickr-crypto-c"
  ...
  # Or just: s.author    = "Tom Leavy"
    s.authors            = { "Tom Leavy" => "tom@wickr.com", "Paul Kushman" => "pkushman@wickr.com" }
  ...
  s.source       = { :git => "git@wkrnjpgit.wickrlan.net:cross-clib/wickr-crypto-c.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "src/crypto/*.{h,c}"
  # s.exclude_files = "Classes/Exclude"

  #s.public_header_files = "src/crypto/*.h"
  s.private_header_files = "src/crypto/*.pb-c.h", "src/crypto/protobuf_util.h"
  # ――― Resources ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  ...
  # s.requires_arc = true
    ...
    s.pod_target_xcconfig = { 'OTHER_LDFLAGS' => '$(inherited) -L${PODS_ROOT}/OpenSSL/lib' }
