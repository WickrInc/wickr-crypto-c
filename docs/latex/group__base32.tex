...
decoded binary data representation of \textquotesingle{}buffer\textquotesingle{} or NULL if \textquotesingle{}buffer\textquotesingle{} contains invalid base32 data 
\end{DoxyReturn}
