...
server communication identifier transmitted to the server and used for salting operations outside of the messaging component of Wickr, such as communicating with the Wickr Server API. \mbox{\Hypertarget{structwickr__dev__info_a084d0cd9e73d9f74f62c9e9abb85436f}\label{structwickr__dev__info_a084d0cd9e73d9f74f62c9e9abb85436f}} 
