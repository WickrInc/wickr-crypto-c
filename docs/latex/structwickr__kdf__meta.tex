...
Represents the information the KDF function will need along with it\textquotesingle{}s input to derive a particular output.  
...
serialized algorithm identifier to help define the set of parameters for the KDF as an integer \mbox{\Hypertarget{structwickr__kdf__meta_abf3edef445c8849c356d1282e49033f4}\label{structwickr__kdf__meta_abf3edef445c8849c356d1282e49033f4}} 
...
context information that can be used as part of the KDF function. INFO varies from SALT as it is not intended to be random, and instead holds contextual information. May be NULL if no context information is provided \mbox{\Hypertarget{structwickr__kdf__meta_a315c54ee4578a01266a4e7352a52d459}\label{structwickr__kdf__meta_a315c54ee4578a01266a4e7352a52d459}} 
