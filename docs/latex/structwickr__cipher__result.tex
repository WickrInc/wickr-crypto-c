...
the calculated authentication tag for the output of the cipher function. Can be NULL if a non-\/authenticated cipher is used \mbox{\Hypertarget{structwickr__cipher__result_a80f15a012dbe1342d0aaa6f3e7072aa9}\label{structwickr__cipher__result_a80f15a012dbe1342d0aaa6f3e7072aa9}} 
