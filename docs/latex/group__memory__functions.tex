...
a pointer to \textquotesingle{}len\textquotesingle{} bytes of newly allocated memory, or NULL if the underlying system allocation fails 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
a pointer to \textquotesingle{}len\textquotesingle{} bytes of newly allocated memory filled with 0s, or NULL if the underlying system allocation fails 
\end{DoxyReturn}
