...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
a key exchange set built from the bytes of \textquotesingle{}buffer\textquotesingle{} or NULL if deserialization fails ~\newline
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the key exchange for \textquotesingle{}identifier\textquotesingle{} or NULL if it cannot be found 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
bytes representing \textquotesingle{}exchange\+\_\+set\textquotesingle{} with protocol buffers or NULL if serialization fails 
\end{DoxyReturn}
